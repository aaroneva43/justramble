  ...
  return (
    <div style={styles}>
      ...
      <div className="demo-section">
        ...
        <Button
          style={{ background: "#e4e6ef", color: "#3f4254", fontWeight: "550" }}
          size="lg"
        >
          Secondary
        </Button>
      ...
      <div className="demo-section">
        ...
        >
          <Form.Group controlId="name">
            <Form.ControlLabel className="sui-form-lable">Default Input</Form.ControlLabel>
            <Form.Control size="lg" placeholder="name@example.com" name="name" />
          </Form.Group>
